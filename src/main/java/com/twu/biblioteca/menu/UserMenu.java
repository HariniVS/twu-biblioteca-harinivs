...
public class UserMenu extends Menu {
    ...
    public UserMenu(Repository repository, OutputWriter outputWriter, InputReader inputReader) {
        ...
        userMenu.put("3", new CheckoutItem(repository, outputWriter, BOOK_ITEM));
        userMenu.put("4", new CheckoutItem(repository, outputWriter, MOVIE_ITEM));
